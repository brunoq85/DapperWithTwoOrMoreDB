...
using DapperWithTwoOrMoreDB.Data;
using DapperWithTwoOrMoreDB.Data.Extensions;
using DapperWithTwoOrMoreDB.Data.Repositories;
using DapperWithTwoOrMoreDB.Services.Interface;
using DapperWithTwoOrMoreDB.Services.Services;
...
namespace DapperWithTwoOrMoreDB.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DapperWithTwoOrMoreDB.API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DapperWithTwoOrMoreDB.API v1"));
            }
